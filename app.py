...
def create_app8_ui():
  ...
  html.H1('Terrorism Analysis with Insights', id='Main_title',style = {'textAlign':'center','font-family':'sans-serif',"background-color": "#1496EC"}),
  dcc.Tabs(id="Tabs", value="Map",children=[
      dcc.Tab(style={'font-family':"Comic Sans MS"},label="Map tool" ,id="Map tool",value="Map", children=[
          dcc.Tabs(style={'font-family':"Comic Sans MS"},id = "subtabs", value = "WorldMap",children = [
              dcc.Tab(style={'font-family':"Comic Sans MS"},label="World Map tool", id="World", value="WorldMap"),
              dcc.Tab(style={'font-family':"Comic Sans MS"},label="India Map tool", id="India", value="IndiaMap")
              ]),
          html.Br(),
          html.Br(),
          dcc.Dropdown(
          ...
          html.H2('Select the Year', id='year_title',style={'font-familt':'sans-serif',"background-color": "#1496EC"}),
          dcc.RangeSlider(
                    id='year-slider',
                    min=min(year_list),
                    max=max(year_list),
